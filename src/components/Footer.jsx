...
const Footer = () => {
  return (
    <footer className="w-full px-[15px] md:px-[30px] text-[15px] md:text-[24px] lg:text-[22px]">
      <div className="grid grid-cols-6 md:grid-cols-12 pt-[6px] md:pt-[10px] lg:pt-[20px] border-t lg:text-[56px]">
      ...
      {/* phone */}
      <div className="md:hidden flex justify-between items-center h-[65px] mt-[200px] border-t">
      ...
      {/* tablet and desktop */}
      <div className="hidden md:grid grid-cols-12 items-center h-[90px] mt-[300px] border-t">
