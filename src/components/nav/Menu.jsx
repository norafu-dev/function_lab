...
export default function Menu({ isOpen, onCloseComplete }) {
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 z-[10] overflow-hidden">
      ...
      >
        <div className="container absolute top-0 left-0 flex flex-col justify-start w-screen menu-full-height pl-[15px] pb-[env(safe-area-inset-bottom)] pt-[40dvh] tracking-[-0.01em] font-twk">
